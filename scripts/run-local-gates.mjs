...
const steps = [
  ...
  ["Kubernetes packaging static smoke", "node", ["scripts/k8s-static-smoke.mjs"]],
  ...
  ["Staging release packet draft validation", "node", ["scripts/validate-staging-release-packet.mjs", "--file", "docs/staging-release-packet-draft-2026-06-27.md"]],
  ["Local staging release packet pilot validation", "node", ["scripts/validate-staging-release-packet.mjs", "--file", "docs/local-staging-release-pilot.md"]],
  ["Controlled-prod readiness packet validator fixtures", "node", ["scripts/validate-controlled-prod-readiness-packet.mjs", "--self-test"]],
