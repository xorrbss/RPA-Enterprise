...
| E2 번역기+StepCards | 진행 | — | — | step-sentences(§5 전수 22케이스)+StepCards. 소비면 2곳 배선: 초안 미리보기(GenerationResult)·계획 미리보기(workbench Plan 대체=T7 절반). url_ref는 기존 urlRefLabel 공유. 위저드 셸·useEasyGeneration은 E3/E4로 |
| E3 PRECHECK 인라인 | 대기 | — | — | — |
| E4 TestProgress | 대기 | — | — | — |
