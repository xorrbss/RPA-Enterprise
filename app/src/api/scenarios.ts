...
import { registerScenarioGovernanceRoutes } from "./scenarios-governance";
import { registerScenarioPromotionRequestRoutes } from "./scenarios-promotion-requests";
import { requirePrincipal, type ApiServerDeps, UUID_RE } from "./server-shared";
import { cloneIrWithVersion, isRecord, mapScenarioVersion, parseIfMatch, parseVersionParam, promoteScenario, promoteScenarioFromRun, resolveRunTargetForIr, signedCommandRefsFor, type ScenarioVersionDetailRow, type ScenarioVersionListRow } from "./scenarios-support";
...
export function registerScenarioRoutes(app: FastifyInstance, deps: ApiServerDeps): void {
  ...
  registerScenarioGovernanceRoutes(app, deps);
  ...
  registerScenarioPromotionRequestRoutes(app, deps);
