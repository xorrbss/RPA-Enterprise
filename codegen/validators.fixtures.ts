...
const CASES: Case[] = [
  ...
  { name: "IR invalid: meta evidence video enum", fn: validateIR, expect: false,
    data: { meta: { name: "t", version: 1, evidence: { video: "sometimes" } }, start: "n1", nodes: { n1: { terminal: "success" } } } },
  ...
  { name: "IR valid: 복귀형 예약 핸들러 closed call", fn: validateIR, expect: true,
    data: { meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { next: { handler: "@human_task", input: { kind: "validation", assignee_role: "reviewer" }, return_node: "n2" } }, n2: { terminal: "success" } } } },
  ...
  { name: "IR valid: extract action instruction + schema_ref 필수 충족", fn: validateIR, expect: true,
    data: { meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { what: [{ action: "extract", instruction: "rows를 추출하라", schema_ref: "rows" }], terminal: "success" } } } },
  { name: "IR invalid: extract action instruction 필수", fn: validateIR, expect: false,
    data: { meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { what: [{ action: "extract", schema_ref: "rows" }], terminal: "success" } } } },
  ...
  { name: "IR valid: api_call SecretRef bearer auth", fn: validateIR, expect: true,
    data: { meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { what: [{ action: "api_call", url_ref: "api_url", args: { method: "GET", headers: { Accept: "application/json" }, auth: { type: "secret_ref_bearer", secret_ref: "secret://prod/connector/http-api/token" } } }], terminal: "success" } } } },
  { name: "IR invalid: api_call url_ref required", fn: validateIR, expect: false,
    data: { meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { what: [{ action: "api_call", args: { method: "GET", auth: { type: "none" } } }], terminal: "success" } } } },
  { name: "IR invalid: api_call raw Authorization header", fn: validateIR, expect: false,
    data: { meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { what: [{ action: "api_call", url_ref: "api_url", args: { method: "GET", headers: { Authorization: "Bearer plaintext" } } }], terminal: "success" } } } },
  { name: "IR invalid: api_call basic auth out of P1 scope", fn: validateIR, expect: false,
    data: { meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { what: [{ action: "api_call", url_ref: "api_url", args: { method: "GET", auth: { type: "basic", username: "u", password: "p" } } }], terminal: "success" } } } },
  { name: "IR invalid: api_call mutation idempotency_key required", fn: validateIR, expect: false,
    data: { meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { what: [{ action: "api_call", url_ref: "api_url", args: { method: "POST", body: { x: 1 }, auth: { type: "none" } } }], terminal: "success" } } } },
...
const STATIC_CASES: StaticCase[] = [
  ...
  {
    name: "Static invalid: registered shell cmd_ref outside browser product mode",
    data: { meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { what: [{ action: "shell", cmd_ref: "signed.export_report" }], terminal: "success" } } },
    expectErrors: ["unsupported_browser_product_action"],
    expectWarnings: [],
    options: { signedCommandRefs: ["signed.export_report"] },
  },
  {
    name: "Static invalid: file action outside browser product mode",
    data: { meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { what: [{ action: "file" }], terminal: "success" } } },
    expectErrors: ["unsupported_browser_product_action"],
    expectWarnings: [],
  },
  {
    ...
    expectErrors: ["unsupported_browser_product_action", "shell_cmd_unregistered"],
    expectWarnings: [],
    options: { signedCommandRefs: ["signed.export_report"] },
  },
  {
    ...
    data: { meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { what: [{ action: "shell", cmd_ref: "signed.export_report" }], terminal: "success" } } },
    expectErrors: ["unsupported_browser_product_action", "shell_cmd_registry_unavailable"],
    expectWarnings: [],
  },
  {
  ...
  },
  {
    ...
    data: scenario({ meta: { name: "t", version: 1 }, start: "n1", nodes: { n1: { next: { handler: "@human_task", input: { kind: "validation", assignee_role: "reviewer" }, return_node: "n2" } }, n2: { terminal: "success" } } }),
    expectErrors: [],
    expectWarnings: [],
  },
  {
