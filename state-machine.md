...
| R5b | running | operator_pause_requested | suspending | runtime-owned pause intent accepted | bookmark 시작(reason=`operator_pause`), checkout timer pause, resume token 발급 |
