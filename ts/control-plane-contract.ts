...
export type ControlPlanePath =
  ...
  | "/v1/offboarding/purge-requests/{request_id}/decide"
  | "/v1/offboarding/purge-requests/{request_id}/cancel"
  ...
  | "/v1/document-jobs/{job_id}/external-extractions"
  ...
  | "/v1/scenario-generations/{generation_id}/revise"
  ...
  | "/v1/scim/principals"
  | "/v1/scim/providers"
  | "/v1/scim/providers/{provider_key}"
  | "/v1/scim/providers/{provider_key}/decommission"
  | "/v1/scim/providers/{provider_key}/group-role-mappings"
  | "/v1/scim/providers/{provider_key}/group-role-mappings/import"
  | "/v1/scim/providers/{provider_key}/group-role-mappings/{mapping_id}"
  ...
  | "/v1/audit-log"
  | "/v1/audit-log/export"
  | "/v1/audit-log/verification-runs"
  ...
  | "/v1/scenarios/{scenario_id}/versions/{version}/certify"
  | "/v1/scenarios/{scenario_id}/versions/{version}/governance-stage"
  | "/v1/scenarios/{scenario_id}/versions/{version}/revoke-certification"
