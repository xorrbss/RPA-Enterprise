...
export interface ApiClientCore {
  ...
  //   409 SCENARIO_VERSION_CONFLICT(동시 수정) / 422 IR_SCHEMA_INVALID + details.reason
  //   (prompt_not_retained·scenario_not_persisted·instruction_required)은 ApiError로 표면화.
